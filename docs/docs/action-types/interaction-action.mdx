...
{/* {/_ | `scroll` | Scroll the page (Currently not supported. Request the founder or contribute to opensource) |
| `switch_tab` | Switch to a different tab |
| `close_current_tab` | Close the current tab |
| `close_all_but_last_tab` | Close all tabs except the last | _/} */}
...
The most common interaction—clicking buttons, links, and other elements. It has got some specific properties that are unique to it apart from the general properties.
